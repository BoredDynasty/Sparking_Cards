...
local function OnCharacterAdded(character)
	...
	runService:BindToRenderStep("SunFlareReposition", Enum.RenderPriority.Last.Value, function()
		...
		local isClear = not IsObstructed((root.Position+Vector3.new(0, 1.5, 0)-camera.CFrame.Position).Magnitude < 1.1 and character or nil) --ignores character when zoomed in
