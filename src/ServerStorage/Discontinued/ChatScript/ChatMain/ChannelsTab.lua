...
local function CreateGuiObjects()
	...
	UnselectedFrame.BackgroundTransparency = ChatSettings.BackGroundTransparency
	UnselectedFrame.Parent = BackgroundFrame
	
	local UICorner = Instance.new("UICorner",UnselectedFrame)
	...
	local UICorner = Instance.new("UICorner",SelectedFrameBackgroundImage)
	UICorner.CornerRadius = ChatSettings.CornerRadius

	SelectedFrameBackgroundImage.BackgroundTransparency = ChatSettings.BackGroundTransparency - 1
	local rate = 1.2 * 0.5
...
function methods:SetActive(active)
	...
	if (active) then
		...
		self.NameTag.Font = ChatSettings.DefaultFont
	else
		self.NameTag.Font = ChatSettings.DefaultFont
...
function methods:FadeInBackground(duration)
	self.AnimParams.Background_TargetTransparency = ChatSettings.BackGroundTransparency
	self.AnimParams.Background_NormalizedExptValue = CurveUtil:NormalizedDefaultExptValueInSeconds(duration)
end
...
function methods:InitializeAnimParams()
	...
	self.AnimParams.Background_TargetTransparency = ChatSettings.BackGroundTransparency
	self.AnimParams.Background_CurrentTransparency = ChatSettings.BackGroundTransparency
