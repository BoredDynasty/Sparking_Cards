...
function methods:CreateGuiObjects(targetParent)
	...
	BaseFrame.BackgroundTransparency = ChatSettings.ChatBarBackGroundTransparency
	BaseFrame.BorderSizePixel = 0
	BaseFrame.BackgroundColor3 = ChatSettings.ChatBarBackGroundColor
	BaseFrame.Parent = targetParent
	
	local UICorner = Instance.new("UICorner",BaseFrame)
	UICorner.CornerRadius = ChatSettings.CornerRadius

	local BoxFrame = Instance.new("Frame")
	BoxFrame.Selectable = false
	BoxFrame.Name = "BoxFrame"
	BoxFrame.BackgroundTransparency = ChatSettings.ChatBarBackGroundTransparency
	...
	local UICorner = Instance.new("UICorner",BoxFrame)
	UICorner.CornerRadius = ChatSettings.CornerRadius
	...
	TextBox.TextTransparency = ChatSettings.ChatBarTextTransparency
...
function methods:FadeInBackground(duration)
	self.AnimParams.Background_TargetTransparency = ChatSettings.ChatBarBackGroundTransparency
	self.AnimParams.Background_NormalizedExptValue = CurveUtil:NormalizedDefaultExptValueInSeconds(duration)
...
function methods:FadeInText(duration)
	self.AnimParams.Text_TargetTransparency = ChatSettings.ChatBarTextTransparency
	self.AnimParams.Text_NormalizedExptValue = CurveUtil:NormalizedDefaultExptValueInSeconds(duration)
end
...
function methods:InitializeAnimParams()
	self.AnimParams.Text_TargetTransparency = ChatSettings.ChatBarTextTransparency
	self.AnimParams.Text_CurrentTransparency = ChatSettings.ChatBarTextTransparency
	self.AnimParams.Text_NormalizedExptValue = 1

	self.AnimParams.Background_TargetTransparency = ChatSettings.ChatBarBackGroundTransparency
	self.AnimParams.Background_CurrentTransparency = ChatSettings.ChatBarBackGroundTransparency
