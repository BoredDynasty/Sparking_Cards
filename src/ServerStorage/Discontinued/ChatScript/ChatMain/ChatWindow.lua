...
function methods:CreateGuiObjects(targetParent)
	...
	ChatChannelParentFrame.BackgroundTransparency = ChatSettings.BackGroundTransparency
	ChatChannelParentFrame.BorderSizePixel = 0
	ChatChannelParentFrame.Parent = BaseFrame
	
	local UICorner = Instance.new("UICorner",ChatChannelParentFrame)
	UICorner.CornerRadius = ChatSettings.CornerRadius
	
	local UIPadding = Instance.new("UIPadding",ChatChannelParentFrame)
	...
	ChatResizerFrame.BackgroundTransparency = ChatSettings.BackGroundTransparency
	...
	local UICorner = Instance.new("UICorner",ChatResizerFrame)
	UICorner.CornerRadius = ChatSettings.CornerRadius
