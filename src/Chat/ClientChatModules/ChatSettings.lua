...
---[[ UICorner Settings ]]
module.CornerRadius = UDim.new(0,5)

---[[ Window Settings ]]
module.MinimumWindowSize = UDim2.new(0.3, 0, 0.25, 0)
module.MaximumWindowSize = UDim2.new(.5, 0, .5, 0) -- Should always be less than the full screen size.
module.DefaultWindowPosition = UDim2.new(0, 4, 0, 0)
