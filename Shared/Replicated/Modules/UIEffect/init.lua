...
function UIEffect:CustomAnimation(effect, object: GuiObject, value)
	...
	if effect == "Hover" and value == true then
		local target =
			UDim2.new(object.Size.X.Scale * 0.9, object.Size.Y.Offset, object.Size.Y.Scale * 0.9, object.Size.Y.Offset)
		Curvy:Curve(object, Curvy.TweenInfo(0.5, "Back", "InOut", 0, false, 0), "Size", target)
	elseif value == false then
		local target = UDim2.new(objectSize.X.Scale, objectSize.X.Offset, objectSize.Y.Scale, objectSize.Y.Offset)
		Curvy:Curve(object, Curvy.TweenInfo(0.5, "Back", "InOut", 0, false, 0), "Size", target)
...
function UIEffect.getModule(module: string): any
